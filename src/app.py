...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the basketball team for drills, practice, and games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["ethan@mergington.edu", "mia@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Practice soccer skills and scrimmage with other students",
    ...
    "Drama Society": {
        "description": "Rehearse and perform plays, monologues, and improv scenes",
        "schedule": "Thursdays, 4:30 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["lucas@mergington.edu", "ella@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Compete in science and engineering challenges with the team",
